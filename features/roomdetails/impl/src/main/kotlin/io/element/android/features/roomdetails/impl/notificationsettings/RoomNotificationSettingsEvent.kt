...
sealed interface RoomNotificationSettingsEvent {
    ...
    data class SetBubbleEnabled(val enabled: Boolean) : RoomNotificationSettingsEvent
    data class ShowSnackbar(val messageResId: Int) : RoomNotificationSettingsEvent
}
